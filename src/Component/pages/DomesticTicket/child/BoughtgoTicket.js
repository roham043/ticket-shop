...
const Boughtgoticket = () => {
    ...
    return (
        ...
        <div className='row'>
            <div className="col-md-8 col-8  rounded-3" style={{ height: 170 }}>
                <div className="row mt-3 ms-3 justify-content-start" style={{ fontFamily: "system-ui" }}><div className="col-xxl-3 col-xl-4 col-lg-2 col-md-3 col-sm-4 col-5 border rounded-5 pb-1" style={{ backgroundColor: "#99D4FF" }}> <CheckBox width={13} height={13} /> بلیط رفت</div> <div className="col-lg-3 col-md-1 col-sm-1 col-sm-5 col-4 fw-bolder fs-5 " >  {goDate} </div></div>
                <div className="row mt-4 ms-4"><div className="col-sm-2 col-3" ><img src={logoGoticket} height={35} width={35} alt="2" /></div> <div className="col-sm-4 col-4 fs-5" style={{ fontFamily: "system-ui" }}>{logonameGoticket}</div></div>

                <div className='row mt-2 ms-3' >
                    <div className='col-xl-1 col-lg-3 col-md-3 col-sm-2 col-3 pt-3 fw-bolder fs-5' style={{ fontFamily: 'system-ui' }}><div className="row " ><div className="col-6 d-none d-md-block "> {orgGoticket}</div> <div className="col-sm-6 ">{gotimeGoticket}</div> </div > </div>
                    ...
                    <div className='col-xl-1 col-lg-3 col-md-3 col-sm-3 col-1 pt-3 fw-bolder fs-5 ' style={{ fontFamily: 'system-ui' }}><div className="row "><div className="col-6 d-none d-md-block ">{destGoticket} </div> <div className="col-sm-6 ">{arrivetimeGoticket}</div > </div > </div>
            ...
            <div className="col-md-4 col-sm-3 col-4 border-start" style={{ height: 170, fontFamily: "system-ui" }}>
                ...
                <div className="row mt-5 justify-content-center">
                    ...
                    <div className="col-md-5 col-7 fs-4 fw-bolder " style={{ color: "#0082E0" }}>{costGoticket}</div>
