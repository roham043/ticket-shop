        ...
        <div className='row'>
            ...
            <div className='col-md-8 col-8 mb-3 mt-3'>
                <div className='row pb-2 ' style={{ fontFamily: 'system-ui' }}>
                    ...
                    <div className='col-md-2 col-4'>{props.backdata.name}</div>
                </div>


                <div className='row mt-md-4 ' >
                    <div className='col-lg-3 col-2 pt-3 fw-bolder fs-4' style={{ fontFamily: 'system-ui' }}><div className="row " ><div className="col-6 d-none d-lg-block ">{props.backdata.org} </div> <div className="col-sm-6">{props.backdata.gotime}</div> </div > </div>
                    <div className='col-lg-4 col-7 w-30 '  ><img src={arrivedestination} alt="1" /></div>
                    <div className='col-lg-3 col-1 pt-3 fw-bolder fs-4 ' style={{ fontFamily: 'system-ui' }}><div className="row "><div className="col-6 d-none d-lg-block ">{props.backdata.dest} </div> <div className="col-sm-6">{props.backdata.arriveTime}</div > </div > </div>
            ...
            <div className='col-md-2 border-start col-12 border-top  '>
                ...
                <div className="row ms-lg-2 ps-2 mt-4"><button className="btn btn-primary fs-5 fw-bolder" style={{ fontFamily: "system-ui" }} onClick={boughtbackticket} >انتخاب پرواز</button></div>
            </div>
        </div >
